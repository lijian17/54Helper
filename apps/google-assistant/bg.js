...
define("app/u", [], function(t, e) {
	...
	e.onlineTime = function(t) {
		// 2019-05-09T02:01:17.909Z->20190509T020117
	...
	// 文件操作
	e.IO = {
		// 最大空间100M(100 * 1204 * 1024)
		_MAXSPACE: 104857600,
		
		/**
		 * 在root目录创建(获取)一个文件
		 * 
		 * @param {Object} t 操作的文件
		 * @param {Object} e 当文件已存在时的处理方式(true:不存在则创建之，存在则抛出错误;false:简单取得文件并返回)
		 * @param {Object} n 成功的回调
		 * @param {Object} r 失败的回调
		 */
		G: function(t, e, n, r) {
			// window.requestFileSystem(type, size, successCallback [,errorCallback ]);
			// type: Window.TEMPORARY(空间不足，系统自动删除),Window.PERSISTENT(持久存储)
			// size: 申请的空间大小
			// successCallback: 成功回调
			// errorCallback: 失败回调(可选参数)
			(window.requestFileSystem || window.webkitRequestFileSystem)(window.PERSISTENT, this._MAXSPACE, function(o) {
				// 在root目录创建文件gbin1.txt
				...
				//}, errorHandler);
				o.root.getFile(t, {create: e}, function(t) {n(o, t)}, r)
			}, r)
		},
		 ...
		 * 
		 * @param {Object} t 操作的文件
		 * @param {Object} e 成功的回调
		 * @param {Object} n 失败的回调
		 */
		R: function(t, e, n) {
			this.G(t, !1, function(t, r) {
				// r = FileEntry对象
				// 调用使用File和FileReader对象读取文件内容
				r.file(function(t) {
		 ...
		 * 
		 * @param {Object} t 操作的文件
		 * @param {Object} n 待追加的内容数组数据
		 * @param {Object} r 成功的回调
		 * @param {Object} o 失败的回调
		 */
		W: function(t, n, r, o) {
			var i = function(t, n, r, o) {
				e.IO.G(t, !0, function(t, e) {
					//创建FileWriter对象，以便对已有文件追加内容
		 ...
		 * 
		 * @param {Object} t 操作的文件
		 * @param {Object} e 结果回调函数(true:成功，false:失败)
		 */
		E: function(t, e) {
...
define("lib/t", [], function(t, e, n) {
	...
	// 算法(t = okpjnkmjijbnffoifemfjenibaehjdlk + zh-cn)
	r.M = function(t) {
		function e(t, e) {
			var n = t[0],
				u = t[1],
...
define("app/t", [], function(t, e) {
	var n, r,
		...
		// okpjnkmjijbnffoifemfjenibaehjdlk + zh-cn
		s = c.M(i.info.appID + i.info.locale),
		l = (i.info.appVersion, {
			redirects: []
		}),
		f = function(t) {
			t || console.error("603 - 规则字符串为空");
	...
	e.R = function(t, e) {
		i.IO.R(s, function(r) {
			...
			try {
				...
				console.error("605 - json 解析规则文件 error " + t), a.off("!", "错误：扩展发生错误"), e()
			}
		}, function() {
	...
	e.C = function(t, e) {
		...
		// 监听请求中，匹配的URL并处理
		chrome.webRequest.onBeforeRequest.addListener(s, {urls: ["http://*/*", "https://*/*"]}, ["blocking"]),
